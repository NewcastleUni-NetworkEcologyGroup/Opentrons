...
def run(protocol: protocol_api.ProtocolContext):
    ...
    DNA_plate = protocol.load_labware('sarstedt_96_skirted_wellplate_200ul_on_coldblock',5,'Source DNA plate')
    ...
    pipette_10.well_bottom_clearance.aspirate = 3
    pipette_10.well_bottom_clearance.dispense = 3
