...
def run(protocol: protocol_api.ProtocolContext):
    ...
    out_tube = protocol.load_labware('opentrons_24_tuberack_generic_2ml_screwcap')
    ...
    #### Step 6 - pause, cover and shake then pool ####
    ...
    #### Step 7 - Pool normalised samples into a single prelibrary tube ####
    left_pipette.well_bottom_clearance.aspirate = 2
    right_pipette.consolidate(10, magplate.wells_by_name(),
                        out_tube,
                        blow_out=False,
                        touch_tip=False,
                        new_tip = 'never')
