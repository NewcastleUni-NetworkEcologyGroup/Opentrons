...
def run(protocol: protocol_api.ProtocolContext):
    ...
    protocol.pause(
            "Have you put 400 ul of SPRI beads per plate in each well column one of the reservoir?")
    ...
    # pipettes
    left_pipette = protocol.load_instrument('p300_multi', mount='left', tip_racks=[tiprack_200]) 
