...
def run_custom_protocol(
    ...
    def oil_height_track():
        nonlocal h_oil
        dh = volume_of_mineral_oil_in_ul/(length*width) # should this be 8*volume_of_mineral_oil_in_ul for a trough?
        h_oil -= dh
...
run_custom_protocol(**{'number_of_destination_plates': 5, 'volume_of_mineral_oil_in_ul': 15.0, 'distance_from_oil_surface_to_opening_of_trough_in_mm': 10.0})
