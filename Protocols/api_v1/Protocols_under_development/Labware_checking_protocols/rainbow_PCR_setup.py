...
tips300 = labware.load('opentrons-tiprack-300ul', '5', 'for oil and mastermix')
tips10_1 = labware.load('opentrons-tiprack-10ul', '3', 'for primers')
tips10_2 = labware.load('opentrons-tiprack-10ul', '6', 'for template DNA')
...
# =============================================================================
# # Define tube parameters for 5ml source tubes
